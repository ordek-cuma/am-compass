...
export const COMPETITORS: Competitor[] = [
  ...
  { name: 'Capital Group', code: 'Capital Group', hq: 'Los Angeles, US', region: 'North America', owner: 'Independent', focus: 'Diversified', category: 'Private / Mutual', website: 'capitalgroup.com', note: 'Home of the American Funds; privately/employee-owned — no income statement. Form ADV + fund filings' },
  ...
  { name: 'HSBC Asset Management', code: 'HSBC T&B', hq: 'London, UK', region: 'Europe', owner: 'Bank', focus: 'ETF / Index', category: 'European-listed', website: 'assetmanagement.hsbc.com', note: 'HSBC’s global asset manager (~$700bn AUM); large UCITS ETF + index range. Repositioned from HSBC INKA Master-KVG (admin-only, no own products) to the product-issuing entity' },
